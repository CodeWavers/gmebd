                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="customer_name_two" class="col-sm-4 col-form-label">Customer Name </label>
                                    <div class="col-sm-8">
                                        <input type="text"  size="100" name="customer_name_two" class=" form-control" placeholder='Customer Name' id="customer_name_two" value="{customer_name_two}" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="paytype" class="form-control" required="" onchange="bank_paymet(this.value)">
                                            ...
                                            <option value="2" <?php if($paytype ==2){echo 'selected';}?>>Cheque Payment</option>
                                            <option value="4"  <?php if($paytype ==4){echo 'selected';}?>>Bank Payment</option>
                                            <option value="3"  <?php if($paytype ==3){echo 'selected';}?>>Bkash Payment</option>
                                        </select>
...
<!--                                </div>-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="paytype" class="form-control" required="" onchange="delivery_type(this.value)">
                                            <option value="">Select Delivery Option</option>
                                            <option value="1" <?php if($delivery_type ==1){echo 'selected';}?>>Pick Up</option>
                                            <option value="2"  <?php if($delivery_type ==2){echo 'selected';}?>>Courier</option>
...
<!--                                    </div>-->
                            ...
                            <div class="col-sm-6" id="bank_div_m">
                                <div class="form-group row">
                                    <label for="bank" class="col-sm-4 col-form-label"><?php
                                        echo display('bank');
                                        ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-7">
                                        <select name="bank_id" class="form-control bankpayment"  id="bank_id_m">
                                            <option value="{bank_id}">{bank_id}</option>
                                            <?php foreach($bank_list as $bank){?>
                                                <option value="<?php echo html_escape($bank['bank_id'])?>" <?php if($bank['bank_id'] == $bank_id){echo 'selected';}?>><?php echo html_escape($bank['bank_name']).' ('.html_escape($bank['ac_number']).')';?></option>
                                            <?php }?>
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select name="courier_id" class="form-control bankpayment"  id="">
                                            ...
                                            <?php foreach($branch_list as $courier){?>
                                                <option value="<?php echo html_escape($courier['courier_id'])?>"<?php if($courier['courier_id'] == $courier_id){echo 'selected';}?>><?php echo html_escape($courier['courier_name']);?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="branch_id" class="form-control bankpayment"  id="">
                                            <option value=""></option>
                                            < <?php foreach($branch_list as $courier){?>
                                                <option value="<?php echo html_escape($courier['branch_id'])?>"<?php if($courier['branch_id'] == $branch_id){echo 'selected';}?>><?php echo html_escape($courier['branch_name']);?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                    <input type="hidden" id="editpayment_type" value="<?php echo $delivery_type;?>" name="">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="bkash_id" class="form-control bankpayment"  id="bkash_id">
                                            ...
                                            <?php foreach($bkash_list as $bkash){?>
                                                <option value="<?php echo html_escape($bkash['bkash_id'])?>" <?php if($bkash['bkash_id'] == $bkash_id){echo 'selected';}?>><?php echo html_escape($bkash['bkash_no']).' ('.html_escape($bkash['ac_name']).')';?></option>
                                            <?php }?>
                                        </select>
                                        <input type="hidden" id="editpayment_type" value="<?php echo $paytype;?>" name="">
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="9%"><?php echo display('serial_no')?></th>
