                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" tabindex="3" class="form-control" name="chalan_no" placeholder="Chalan No:" id="invoice_no" value="{chalan_no}" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Expired Date<i class="text-danger">*</i></th>
                                ...
                                <tr>
                                    <td class="span3 supplier">
                                        <input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list({sl});" placeholder="<?php echo display('product_name') ?>" id="product_name_{sl}" tabindex="5" value="{product_name} ({product_model})"  >
                                    ...
                                    <td class="wt"> <input type="text"  placeholder="SN" name="sn[]" value="{sn}" id="sn" class="form-control text-right stock_ctn_1"  /></td>
                                    ...
                                    <td class="wt"> <input type="text" placeholder="Lot Number" value="{lot_number}" name="lot_number[]" id="lot_number" class="form-control text-right stock_ctn_1"  /></td>
                                    <td class="wt"> <input type="text" placeholder="Origin" name="origin[]" value="{origin}" id="origin" class="form-control text-right stock_ctn_1"  /></td>
