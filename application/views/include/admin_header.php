                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php elseif($birthday_count > 1):?>
                            ...
                            <li><a href="<?php echo base_url('Creport/birthday_noti') ?>"><i class="pe-7s-users"></i><?php echo html_escape($birthday[0]['first_name']) ?>  and <?php echo html_escape($birthday_count-1) ?> others have birthdays today.Click and see other birthday peoples.</a></li>
                        <?php else:?>
                            <li><a href="<?php echo base_url('Creport/birthday_noti') ?>"><i class="pe-7s-users"></i><?php echo html_escape($birthday[0]['first_name']) ?> birthday today</a></li>
                        <?php endif;?>
                    </ul>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($this->permission1->method('sales_cheque_report','create')->access()){ ?>
                            ...
                            ?>"><a href="<?php echo base_url('Admin_dashboard/sales_cheque_report') ?>">Manage Cheque</a></li>
                        <?php } ?>
            ...
            <!-- Invoice menu end -->
             ...
             <!-- Discount menu start -->
            <?php if($this->permission1->method('new_discount','create')->access() || $this->permission1->method('manage_invoice','read')->access() || $this->permission1->method('pos_invoice','create')->access() || $this->permission1->method('gui_pos','create')->access()){?>
                <li class="treeview <?php
                if ($this->uri->segment('1') == ("Cdiscount")) {
                    echo "active";
                } else {
                    echo " ";
                }
                ?>">
                    ...
                    <ul class="treeview-menu">
                        <?php if($this->permission1->method('new_invoice','create')->access()){ ?>
                            <li  class="treeview <?php
                            if ($this->uri->segment('1') == ("Cdiscount") && $this->uri->segment('2') == ("")) {
                                echo "active";
                            } else {
                                echo " ";
                            }
      ...
      <!--                   <?php if($this->permission1->method('gui_pos','create')->access()){ ?>
        ...
        <!--                 <?php if($this->permission1->method('sales_cheque_report','create')->access()){ ?>
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($this->permission1->method('customer_ledger','read')->access()){ ?>
                            ...
                            ?>"><a href="<?php echo base_url('Ccustomer/customer_ledger_report_cheque') ?>">Paid Cheque</a></li>
                        <?php } ?>
            ...
            <!-- Purchase menu start -->
            <?php if($this->permission1->method('add_purchase','create')->access() ||$this->permission1->method('previous_stock','create')->access() || $this->permission1->method('manage_purchase','read')->access()){?>
                <li class="treeview <?php
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($this->permission1->method('previous_stock','create')->access()){ ?>
                            <li class="treeview <?php
                            if ($this->uri->segment('1') == ("Cpurchase") && $this->uri->segment('2') == ("")) {
                                echo "active";
                            } else {
                            ...
                            ?>"><a href="<?php echo base_url('Cpurchase/previous_stock') ?>">Previous Purchase</a></li>
                        <?php } ?>
            ...
            <?php if($this->permission1->method('warrenty_return','create')->access() || $this->permission1->method('return_list','read')->access() || $this->permission1->method('supplier_return_list','read')->access() || $this->permission1->method('wastage_return_list','read')->access()){?>
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        //                    } else {
                        //                        echo " ";
                        //                    }?><!--"><a href="--><?php //echo base_url('Cwarrenty/return_list') ?><!--">Stock return list</a></li>-->
                        <!--                      --><?php //} ?>
                        ...
                        <?php if($this->permission1->method('exchange_stock_list','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("exchange_stock_list")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Cwarrenty/exchange_stock_list') ?>">Exchange stock list</a></li>
                        <?php } ?>
                        ...
                        <?php if($this->permission1->method('wastage_return_list','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("wastage_return_list")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Cwarrenty/wastage_return_list') ?>">Wastage Stock</a></li>
                        <?php } ?>
                        ...
                        <?php if($this->permission1->method('repair_report_list','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("repair_report_list")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Cwarrenty/repair_report_list') ?>">Repair Report</a></li>
                        <?php } ?>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($this->permission1->method('purchase_warrenty_report','create')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("purchase_warrenty_report")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Admin_dashboard/purchase_warrenty_report') ?>">Purchase Warrenty Report</a></li>
                        ...
                        <?php if($this->permission1->method('purchase_report_shelf_wise','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("purchase_report_shelf_wise")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Admin_dashboard/purchase_report_shelf_wise') ?>">Warehouse Wise Report</a></li>
                        ...
                        <?php if($this->permission1->method('reorder_report','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("reorder_report")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Admin_dashboard/reorder_report') ?>">Re-order Level Report</a></li>
                        ...
                        <?php if($this->permission1->method('sales_warrenty_report','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("sales_warrenty_report")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Admin_dashboard/sales_warrenty_report') ?>">Sales Warrenty Report</a></li>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($this->permission1->method('credit_voucher','create')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("credit_voucher")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('accounts/money_reciept') ?>">Money Reciept</a></li>
                        <?php }?>
                        ...
                        <?php if($this->permission1->method('ac_report','create')->access()){ ?>
                            ...
                            ?>"><a href=""><?php echo display('report') ?>
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <?php if($this->permission1->method('supplier_payment_report','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("general_ledger")){
                                            echo "active";
                                        } else {
                                            echo " ";
                                        }?>"><a href="<?php echo base_url('admin_dashboard/supplier_payment_report') ?>">Supplier Payment Report</a></li>
                                    <?php } ?>

                                    <?php if($this->permission1->method('customer_recieve_report','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("general_ledger")){
                                            echo "active";
                                        } else {
                                            echo " ";
                                        }?>"><a href="<?php echo base_url('admin_dashboard/customer_recieve_report') ?>">Customer Recieve Report</a></li>
                                    <?php } ?>
                                    ...
                                    <li class="treeview <?php if ($this->uri->segment('2') == ("profit_loss_report")){
                                        ...
                                        echo " ";
                                    }?>"><a href="<?php echo base_url('accounts/profit_loss_report_search') ?>"><?php echo display('profit_loss'); ?></a></li>
                                    ...
                                    <?php if($this->permission1->method('balance_sheet_report','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("balance_sheet_report")){
                                            echo "active";
                                        } else {
                                            echo " ";
                                        }?>"><a href="<?php echo base_url('accounts/balance_sheet_report_search_new') ?>">Balance Sheet</a></li>
                                    <?php } ?>
                    ...
                    <ul class="treeview-menu">
                        <?php if($this->permission1->method('add_bkash_number','create')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('1') == ("Csettings") && $this->uri->segment('2') == ("index")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Csettings/bkash') ?>">Add Bkash Number</a></li>
                        <?php }?>
                        ...
                        <?php if($this->permission1->method('bkash_list','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("bkash_list")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Csettings/bkash_list') ?>">Manage Bkash</a></li>
                        <?php }?>
                        <?php if($this->permission1->method('bkash_transaction','create')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("bkash_transaction")){
                                echo "active";
                            } else {
                                echo " ";
                            }?>"><a href="<?php echo base_url('Csettings/bkash_transaction') ?>">Bkash Transaction</a></li>
                        <?php }?>

                        <?php if($this->permission1->method('bkash_ledger','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("bkash_ledger")){
                                echo "active";
                            } else {
                                echo " ";
                            }?>"><a href="<?php echo base_url('Csettings/bkash_ledger') ?>">Bkash Ledger</a></li>
                        <?php }?>
                    </ul>
                </li>
            <?php } ?>
