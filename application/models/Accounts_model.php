...
// =================== Settings data ==============================
    ...
    public function trial_secondquery($dtpFromDate,$dtpToDate,$COAID){
        $sql = "SELECT SUM(acc_transaction.Credit) as total_credit , SUM(acc_transaction.Debit) as total_debit FROM acc_transaction INNER JOIN acc_coa ON acc_transaction.COAID = acc_coa.HeadCode WHERE acc_transaction.IsAppove = 1 AND  COAID LIKE '$COAID%'";
