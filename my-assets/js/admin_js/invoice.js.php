    ...
    var options = {
        ...
        select: function( event, ui ) {
            ...
            ({
                ...
                data: {product_id:id,customer_id:customer_id,csrf_test_name:csrf_test_name},
                cache: false,
                success: function(data)
                {
